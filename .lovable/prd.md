...
- **Correção factual Bulgária (2026-06-03):** acordo Brasil–Bulgária está em vigor desde 2024. `bulgaria` reclassificada de `incompleto` → `vigente` (vigencia 2024). Site passa a refletir **22 vigentes + 3 em ratificação + 0 incompletos = 25 mapeados** automaticamente via `siteStats`.
